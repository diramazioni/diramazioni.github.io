...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! jQuery UI - v1.12.1 - 2017-03-22
* http://jqueryui.com
* Includes: effect.js
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uikit__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uikit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_uikit__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_uikit_icons__ = __webpack_require__(17);
...
function letterOUT(letter, fillColor, radius) {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#'+letter).find('rect').each(function() {

    if (!(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('id') in initial)) {
      initial[__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('id')] = [__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('x'), __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('y')]
    }
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).animate({
      top: rIntRange(-radius, radius)
    },{
      step: function(ry,fx){
        // var col = 'rgb('+Math.floor(Math.abs(ry))+', 0,0)'
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('y', ry);
        // $(this).attr('fill', fillColor );
        if (ry>0) {__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('rx', ry)};
...
function letterIN(letter, fillColor) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#'+letter).find('rect').each(function() {
    var start = initial[__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('id')]
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).animate({
      top: start[1],
    },{
      step: function(ry,fx){
